...
class FieldGroups
{
    ...
    public function __construct()
    {
        ...
        add_action('acf/init', [$this, 'init_custom_acf_location_rules']);
    ...
    private function setup_field_group_locations(): void
    {
        ...
        $filtered_location_rule = [
            'param' => 'rhseo_field_group_location_filtered',
            'operator' => '==',
            'value' => true,
        ];
    ...
    private function add_fields()
    {
        ...
        $fields = [
            ...
            [
                ...
                'label' => __('Document Title for Search Engines', 'rhseo'),
                'acfml_multilingual' => true,
                'rhseo_render_field' => !$this->is_global_options_page()
            ],
            [
                ...
                'label' => $this->is_global_options_page() ? __('Site Description', 'rhseo') : __('Meta Description', 'rhseo'),
                'required' => false,
                'instructions' => __('Recommended length: 50–160 characters', 'rhseo'),
                'max' => 200,
                'rows' => 2,
                'acfml_multilingual' => true,
            ],
    ...
    /**
     * Registers the custom filterable field group location 'rhseo_field_group_location_filtered'
     *
     * @return void
     */
    public function init_custom_acf_location_rules(): void
    {
        if (function_exists('acf_register_location_type')) {
            acf_register_location_type('\RAH\SEO\FieldGroupLocationFiltered');
        }
    }
}
